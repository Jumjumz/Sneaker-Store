          ...
          <>
            ...
            >
              ...
              <div className=" bg-gry-500 w-full h-[40%] flex flex-col flex-wrap justify-evenly pl-4 pr-4 pb-2">
                ...
                <button className="md:h-8 md:text-base md:font-extrabold w-full h-4 bg-coral-900 text-white text-xs rounded-md">
                  BUY NOW
                </button>
                <button className="md:h-8 md:text-base md:font-extrabold w-full h-4 bg-blu-800 text-white text-xs font-light rounded-md">
                  ADD TO CART
                </button>
              </div>
            </div>
